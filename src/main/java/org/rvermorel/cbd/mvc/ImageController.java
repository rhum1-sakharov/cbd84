...
public class ImageController {
	...
	@RequestMapping(value = "/{type}/{imgExtension}/{id}", method = { RequestMethod.GET })
	public ResponseEntity<byte[]> image(@PathVariable String id, @PathVariable String imgExtension,@PathVariable String type) {
