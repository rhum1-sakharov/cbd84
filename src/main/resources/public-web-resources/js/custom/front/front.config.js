											...
											"main" : {
												...
												controller : function($scope,
													...
													$scope.gridEventOptions = {
														...
														exporterFieldCallback : function(
																grid, row, col,
																input) {
											...
											"main" : {
												...
												controller : function($scope,
													...
													$scope.gridRankingOptions = {
														...
														// cellTemplate : '
														// <span
														// stars="{{row.entity.pointCumul}}"
														// twenty-five="{{grid.appScope.percentiles.twentyFive}}"
														// seventy-five="{{grid.appScope.percentiles.seventyFive}}"
														// median="{{grid.appScope.percentiles.median}}"></span>'
														// }
														]
													};
										...
										views : {
											"main" : {
												...
												controller : function($scope,
													...
													$scope.formatInfoResult = function(
															author, ts) {
